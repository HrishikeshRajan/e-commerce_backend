...
const create = async (req, res, next) => {
    try {
        ...
        (0, lodash_1.merge)(req.body, { startTime: new Date(req.body.startTime) });
        (0, lodash_1.merge)(req.body, { endTime: new Date(req.body.endTime) });
...
const getAllPromos = async (req, res, next) => {
    try {
        const result = await promoModel_1.default.find({ status: 'ACTIVE' });
        const response = {
